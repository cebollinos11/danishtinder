...
export default {
  ...
  strings: {
    ...
    leftOf: "quedan {left} de {total}",
    scoreLine: "{right} bien / {wrong} falladas",
    runOf: "{step} / {total} en esta ronda",
    runComplete: "Ronda completada",
    runScoreLine: "{right} de {total} correctas",
    ...
    missionCorrectLabel: "Correctas en esta misión",
    runsLeftLabel: {
      one: "ronda restante",
      other: "rondas restantes",
    },
